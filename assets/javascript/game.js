var moviesArray = ["The Godfather", "The Shawshank Redemption", "Schindler's List", "Raging Bull", "Casablanca", "Citizen Kane", "Gone with the Wind", 
				   ...
				   "It's a Wonderful Life", "Dr. Strangelove or: How I Learned to Stop Worrying and Love the Bomb", "Some Like It Hot", "Ben-Hur", 
...
 
var randomWord = Math.floor(Math.random() * moviesArray.length);
